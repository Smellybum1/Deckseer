...
def handle_empirical_workflow_command(args: argparse.Namespace) -> int | None:
...
def register_empirical_workflow_commands(subparsers: argparse._SubParsersAction) -> None:
