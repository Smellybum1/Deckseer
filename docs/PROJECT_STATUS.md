...
5. Broader advice modules: relic choice is the approved first surface. `docs/RELIC_CHOICE_DESIGN.md` defines the design boundary; the next packet should be a relic metadata seed plan before runtime advice behavior is added.
